...
export class UserService {
  ...
  async findAll() {
    ...
    const userDto = userAbstract.map<User>(user => ({
      id: user.codigo,
      id_user_status: user.cdgEstUsuario.codigo,
      id_user_level: user.cdgNvlUsuario.codigo,
      id_user_type: user.cdgTpoUsuario.codigo,
      id_legal_person: user.cdgPrsJuridica.codigo,
      id_marital_status: user.cdgEstCivil,
      id_matrimonial_regime: user.cdgRgmMatrimonial.codigo,
      id_country: user.cdgPais.codigo,
      ...
      id_origin: user.cdgOrigen.codigo,
      id_nationality: user.cdgNacionalidad.codigo,
      id_language: user.cdgIdioma,
      id_profession: user.cdgProfesion,
      id_commercial_activity: user.cdgGiro.codigo,
      id_national_ocupation: user.cdgCdgNcnOcupacion.codigo,
      id_education_level: user.cdgEscolaridad.codigo,
      id_professional_title: user.cdgTtlProfesional.codigo,
      id_gender: user.cdgSexo.codigo,
      id_created_by: user.cdgEmpAlta,
      id_updated_by: user.cdgEmpModificacion,
      id_deleted_by: user.cdgEmpBaja,
      id_satatus_provider_banorte: user.cdgEstPrvBanorte.codigo,
      id_satatus_employee_banorte: user.cdgEstEmpBanorte.codigo,
      id_public_office: user.cdgCrgPublico.codigo,
      id_company_size: user.cdgTmnEmpresa.codigo,
      id_resource_origin: user.cdgOrgRecurso.codigo,
      id_resource_destination: user.cdgDstRecurso.codigo,
